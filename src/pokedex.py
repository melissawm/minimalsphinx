...
class StarterPokemon:
    ...
    Actual Pokémon can be created by calling the specific classes defining the starter Pokémon types. You can see more details about them at :ref:`starter`.
    """
    def __init__(self):
        self.name = None
        self.evolution = None
    ...
    def who_is_that_pokemon(self):
        ...
        print(f"It will evolve into {[name+', ' for name in self.evolution[:-1]]} and {self.evolution[-1]}.")
...
class Bulbasaur(StarterPokemon):
    ...
    Along with :class:`Charmander` and :class:`Squirtle`, Bulbasaur is one of three starter Pokémon of Kanto available at the beginning of Pokémon Red, Green, Blue, FireRed, and LeafGreen. 
    """
    def __init__(self):
        self.name = "Bulbasaur"
...
class Charmander(StarterPokemon):
    ...
    Along with :class:`Bulbasaur` and :class:`Squirtle`, Charmander is one of three starter Pokémon of Kanto available at the beginning of Pokémon Red, Green, Blue, FireRed, and LeafGreen. 
    ...
    def __init__(self):
        ...
        self.ability = "Blaze"
        self.evolution = ["Charmeleon", "Charizard", "Mega Charizard X", "Mega Charizard Y", "Gigantamax Charizard"]
...
class Squirtle(StarterPokemon):
    ...
    Along with :class:`Bulbasaur` and :class:`Charmander`, Squirtle is one of three starter Pokémon of Kanto available at the beginning of Pokémon Red, Green, Blue, FireRed, and LeafGreen. 
    """
    def __init__(self):
        self.name = "Squirtle"
